  ...
  const state = {
    ui: {
      es: ['Su Membresía (',') no le permite accesar este contenido!', 'Control de Acceso','! Bienvenido, ',
        ' Wow: Tu si puedes ver','Apoyenos', 'Su membresia es: ','Debes elevar su membresia para accesar contenido exclusivo! Simple:',
        'Membresias'
      ],
      en: ['Your membership (',') isn\'t enough to access that content!', 'Access Control','! Wellcome, ',
        'Wow: You can watch this','Support us', 'Your membership is: ','You must level up to see special content! Just: ',
        'Level Up'
      ]
    },
    level: {
