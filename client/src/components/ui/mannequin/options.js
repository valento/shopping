          ...
          <div className='body-part-menu '>
            <Button.Group>
              {menu.map( e => {
                ...
                return (
                  <Button key={'mmenu_'+ind} onClick={this.onMainClick} name={'mmenu_'+ind} basic color='black'>{e}</Button>
                )
              })}
            </Button.Group>
          </div>
              ...
              return (
                <div key={indx} className='body-part-menu'>
                  <Button.Group >
                    ...
                    {en.map( ( e, indx ) => {
                      return (<Button key={e+'_'+indx.toString()} onClick={this.onClick} color='grey'>{e}</Button>)
                    })}
                  </Button.Group>
                </div>
              )
